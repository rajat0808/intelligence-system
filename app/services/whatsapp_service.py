...
def send_whatsapp_template(
    ...
    *,
    ...
    payload_obj = _build_template_payload(
        ...
        supplier=_normalize_required(supplier, "supplier"),
        mrp=_normalize_required(mrp, "mrp"),
        branch_code=_normalize_required(branch_code, "branch_code"),
