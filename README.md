...
python -m pip install fastapi "uvicorn[standard]" sqlalchemy pydantic-settings

# Run from the repo root and set PYTHONPATH to the parent so `app.*` imports resolve.
$env:PYTHONPATH = ".."
